...
CMAKE_ARGS = -DCMAKE_TOOLCHAIN_FILE=$(PROJECT_ROOT)/qnx.nto.toolchain.cmake \
             ...
             -DINSTALL_TESTS=$(BUILD_TESTING) \
             -DOPENCV_TEST_INSTALL_PATH=$(INSTALL_ROOT)/$(CPUVARDIR)/$(PREFIX)/bin/opencv_tests \
             -DOPENCV_PYTHON_INSTALL_PATH=$(INSTALL_ROOT)/$(CPUVARDIR)/$(PREFIX)/lib/python3.11/site-packages \
